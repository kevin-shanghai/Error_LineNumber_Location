...
{
    char cmd[128];
    sprintf(cmd, "addr2line -e %s 0x%x > errorLocation.txt", So_Name, OffsetAddress);                 //log the error location to the file errorLocation.txt
    system(cmd);
    printf("The error line number is:\n");
